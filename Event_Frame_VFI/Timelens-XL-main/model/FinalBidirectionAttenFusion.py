...
from model.encoder_module import EventsEncoder, ImageEncoder
from model.flow_decoder import FlowDecoder, MaskNet
...
class FinalBidirectionAttenfusion(nn.Module):
	...
	def forward(self, x, event, interp_ratio, end_time=None):
		...
		self.tracker.track("Encoder") # if set Ttraker True, this will record time consuming for Encoder block
